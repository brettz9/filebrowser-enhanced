...
//l('mstr:' + this[method]);
	...
	var result = this[method].apply(this, privAPI.concat([].slice.call(arguments, 3)).concat(worker.port.emit.bind(worker.port), worker.port.on.bind(worker.port), worker, sendResponse));
