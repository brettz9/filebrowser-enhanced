...
exports.autocompleteValues = function (data, emit, on, worker, sendResponse) {
    ...
    var searchTerms = searchTermPatterns[1] || searchTermPatterns[3] || userVal;
    var hasDrive = searchTermPatterns[0];
    var driveOnly = searchTermPatterns[2];
    var driveAtEnd = searchTermPatterns[4];
    if (!hasDrive) {
